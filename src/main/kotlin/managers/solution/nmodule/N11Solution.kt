...
class N11Solution: BaseSolution, NModule {
    ...
    override fun makeResult(solution: Solution): String {
        return divisionNaturalWithNatural(Natural(solution.number1), Natural(solution.number2)).value.toString()
    }

    fun divisionNaturalWithNatural(number1: Natural, number2: Natural): Natural {
